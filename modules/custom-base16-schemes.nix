...
# Format matches nix-colors' `colorSchemes.<name>` shape exactly:
#   { slug; name; author; palette = { base00..base0F = "RRGGBB"; }; }
# This is the format nix-colors' home-manager `colorScheme` option expects
# (so `config.colorScheme.palette.base00` resolves to the hex string).
{
  ethereal = {
    slug = "ethereal";
    name = "Ethereal";
